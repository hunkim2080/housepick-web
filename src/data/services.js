...
export const servicePages = {
  faq: {
    slug: 'faq',
    url: '/faq',
    title: '케라폭시 줄눈시공 Q&A | 경화시간, 비용 총정리',
    description: '케라폭시 경화시간 24시간, 화장실 30만원. 폴리우레아와 차이점은? 애완동물 안전할까? 줄눈시공 전 꼭 알아야 할 질문 BEST 10.',
    keywords: '케라폭시, 줄눈시공질문, 줄눈FAQ, 줄눈시공궁금, 줄눈비용, 줄눈시간, 폴리우레아',
    h1: '케라폭시 줄눈시공 Q&A | 경화시간, 비용 총정리',
    subtitle: '케라폭시 경화시간 24시간, 화장실 30만원. 줄눈시공 전 꼭 알아야 할 질문들',
    schemaType: 'FAQPage',
    priority: 1
  },
  types: {
    slug: 'types',
    url: '/types',
    title: '케라폭시 vs 폴리우레아 | 줄눈 종류 6가지 비교',
    description: '케라폭시, 폴리우레아, 아덱스, 빅라이언 장단점 완벽 비교. 화장실엔 케라폭시? 폴리우레아? 공간별 추천 자재 가이드.',
    keywords: '케라폭시, 폴리우레아, 줄눈종류, 케라폭시줄눈, 폴리우레아줄눈, 아덱스줄눈, 빅라이언줄눈',
    h1: '케라폭시 vs 폴리우레아 | 줄눈 종류 6가지 비교',
    subtitle: '화장실엔 케라폭시? 폴리우레아? 공간별 추천 자재 가이드',
    schemaType: 'Article',
    priority: 2
  },
  bathroom: {
    slug: 'bathroom',
    url: '/bathroom',
    title: '화장실 케라폭시 줄눈시공 | 30만원~ 2시간 완료',
    description: '화장실 케라폭시 줄눈시공 신축 30만원, 구축 35만원. 시공 과정 5단계, 자재 선택법, 주의사항까지 총정리.',
    keywords: '케라폭시, 화장실줄눈, 화장실줄눈시공, 욕실줄눈, 화장실줄눈가격, 구축화장실줄눈, 신축화장실줄눈',
    h1: '화장실 케라폭시 줄눈시공 | 30만원~ 2시간 완료',
    subtitle: '화장실 케라폭시 신축 30만원, 구축 35만원. 시공 5단계 완벽 정리',
    schemaType: 'HowTo',
    priority: 3
  },
  price: {
    slug: 'price',
    url: '/price',
    title: '2026 케라폭시 줄눈시공 가격표 | 30만원~',
    description: '케라폭시 화장실 바닥 30만원, 전체 90만원, 거실 150만원. 폴리우레아 가격 비교, 신축/구축 차이, 세트 할인까지 총정리.',
    keywords: '케라폭시가격, 줄눈시공가격, 줄눈가격, 줄눈비용, 화장실줄눈가격, 거실줄눈가격, 폴리우레아가격',
    h1: '2026 케라폭시 줄눈시공 가격표 | 30만원~',
    subtitle: '케라폭시 화장실 바닥 30만원, 전체 90만원, 거실 150만원',
    schemaType: 'Product',
    priority: 4
  },
  review: {
    slug: 'review',
    url: '/review',
    title: '케라폭시 줄눈시공 후기 | 평점 4.9/5.0',
    description: '케라폭시 줄눈시공 실제 고객 후기. Before/After 사진으로 확인. 강남, 수원, 성남 시공 사례 모음.',
    keywords: '케라폭시후기, 줄눈시공후기, 줄눈업체후기, 줄눈시공전후, 줄눈시공사진',
    h1: '케라폭시 줄눈시공 후기 | 평점 4.9/5.0',
    subtitle: '케라폭시 줄눈시공 실제 고객 후기. Before/After 사진으로 확인하세요.',
  ...
  'self-diy': {
    slug: 'self-diy',
    url: '/self-diy',
    title: '케라폭시 셀프 줄눈 vs 업체 시공 | 뭐가 이득?',
    description: '셀프 3~5만원 vs 업체 30만원. 케라폭시는 셀프 가능할까? 비용, 난이도, 결과물 솔직 비교.',
    keywords: '케라폭시셀프, 셀프줄눈시공, 줄눈셀프, 셀프줄눈후기, DIY줄눈, 줄눈시공방법',
    h1: '케라폭시 셀프 줄눈 vs 업체 시공 | 뭐가 이득?',
    subtitle: '셀프 3~5만원 vs 업체 30만원. 케라폭시는 셀프 가능할까?',
    schemaType: 'Article',
    priority: 6
  },
  find: {
    slug: 'find',
    url: '/find',
    title: '케라폭시 줄눈업체 고르는 법 | 5가지 체크리스트',
    description: '케라폭시 전문 업체인지? 기계 제거하는지? 보증서 주는지? 바가지 안 쓰는 업체 선택 기준.',
    keywords: '케라폭시업체, 줄눈업체추천, 줄눈전문업체, 줄눈업체고르는법, 줄눈시공업체, 구축줄눈업체',
    h1: '케라폭시 줄눈업체 고르는 법 | 5가지 체크리스트',
    subtitle: '케라폭시 전문 업체인지? 기계 제거하는지? 보증서 주는지?',
    schemaType: 'Article',
    priority: 7
  }
};
...
export function generateHowToSchema() {
  return {
    "@context": "https://schema.org",
    "@type": "HowTo",
    "name": "화장실 케라폭시 줄눈시공 방법",
    "description": "화장실 케라폭시 줄눈시공의 전체 과정을 단계별로 안내합니다.",
...
export function generateProductSchema() {
  return {
    ...
    "@type": "Product",
    "name": "케라폭시 줄눈시공 서비스",
    "description": "케라폭시, 폴리우레아 줄눈시공 전문. 화장실, 거실, 현관 등 공간별 시공",
    "brand": {
      "@type": "Brand",
      "name": "하우스Pick"
    },
...
export function generateReviewSchema() {
  ...
  return {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "name": "하우스Pick - 케라폭시 줄눈시공 전문",
    "description": "케라폭시, 폴리우레아 줄눈시공 전문. 업계 최초 정찰제, 5년 무상보장.",
